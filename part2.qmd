...
table1(~ age + htn + diab3cat + idealhealthsmk + bmi3cat + totchol3cat| stroke*contacttype, data=data)
...
| AGE               | - Age (in years) of participant at time of visit 1 - Age, based on birth date and clinic visit date, rounded to 0.1                                                                                                                                                                                                                 |
