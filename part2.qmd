...
table1(~ as.factor(stroke_allevt) +  as.factor(stroke_incevt) + contacttype + age+ as.factor(htn) + as.factor(diab3cat) + as.factor(idealhealthsmk) + as.factor(bmi3cat)+ as.factor(totchol3cat) , data = data)
```
