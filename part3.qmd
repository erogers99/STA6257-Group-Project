...
The Cox PH can is the hazard function, $h(t)$, which is determined by the baseline hazard ($h_0(t)$), a set of variables ($x_1, x_2, … x_p$), and the effect of each variable is determined by their coefficient ($b_1, b_2 … b_p$) (Bradburn, Clark, Love & Altman, 2003), mathematically shown as:
