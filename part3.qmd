...
autoplot(aareg(obj ~ data$age + data$htn + data$diab3cat + data$idealhealthsmk + data$bmi3cat + data$totchol3cat), xlab = c("Age", "HTN", "Diabeties", "Smoking", "BMI", "Cholesterol"))
```


The above plots show how the effects of the covariates change over time.
